...
function resizePlayerStyle(event) {
	...
	// commented these lines, 1st if block checks the window to be in the fullscreen to setUpNormalizeAndQuantize
	// 2nd if block, just resizes, and that is not making any improvised difference
...
function start() {
	...
	// qualityStatus.className = "greyStatus";
