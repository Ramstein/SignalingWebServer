...
(function (root, factory) {
    ...
    function webRtcPlayer(parOptions) {
        ...
        //The SDP attribute extmap-allow-mixed, as defined in RFC8285, will be included in the SDP offer if this property is set to true.
        //The SDP attribute extmap-allow-mixed is supported from Chrome 71, but due to backwards compatibility problems it was not included in the SDP offer by default.
        this.cfg.offerExtmapAllowMixed = false;
        //end fix  
